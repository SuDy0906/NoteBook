...
function AddNote (props){
  ...
  return (
    <div>
        <div className="container max-w-screen-2xl pt-2 mx-auto mt-5 px-40">
      <form className="bg-gray-900">
        <div className="boxed bg-gray-700 p-5">
        <div className="space-y-3 ">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-neutral-50">Add Note</h2>

          
            <div className='boxed bg-gray-800'>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <div className="mt-1 grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-6">
              ...
              <div className="col-span-full boxed bg-gray-800">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-3 boxed bg-gray-800">
          ...
          <div>
            <button
              disabled={note.title.length<5  || note.description.length<5} className="middle none center rounded-2xl bg-gray-800 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-500/20 transition-all hover:shadow-lg hover:shadow-gray-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
