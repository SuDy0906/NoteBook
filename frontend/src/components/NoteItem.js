...
function NoteItem(props) {
    ...
    return (
        ...
        <div className="boxed relative flex w-96 flex-col rounded-xl bg-gray-800 bg-clip-border text-neutral-100 my-3 shadow-md w-auto">
            ...
            <div className="p-6">
                ...
                <span
                    class="mt-4 px-3 w-min flex justify-between items-center text-xs sm:text-sm bg-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-2xl py-2 font-bold leading-loose cursor-pointer dark:text-gray-300 ">
